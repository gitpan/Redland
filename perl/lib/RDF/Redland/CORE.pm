...
*librdf_world_set_logger = *RDF::Redland::COREc::librdf_world_set_logger;
...
*librdf_uri_compare = *RDF::Redland::COREc::librdf_uri_compare;
...
*librdf_new_node_from_uri_local_name = *RDF::Redland::COREc::librdf_new_node_from_uri_local_name;
*librdf_new_node_from_normalised_uri_string = *RDF::Redland::COREc::librdf_new_node_from_normalised_uri_string;
...
*librdf_node_get_li_ordinal = *RDF::Redland::COREc::librdf_node_get_li_ordinal;
...
*librdf_statement_is_complete = *RDF::Redland::COREc::librdf_statement_is_complete;
...
*librdf_model_add_string_literal_statement = *RDF::Redland::COREc::librdf_model_add_string_literal_statement;
...
*librdf_model_transaction_start = *RDF::Redland::COREc::librdf_model_transaction_start;
*librdf_model_transaction_commit = *RDF::Redland::COREc::librdf_model_transaction_commit;
*librdf_model_transaction_rollback = *RDF::Redland::COREc::librdf_model_transaction_rollback;
...
*librdf_parser_check_name = *RDF::Redland::COREc::librdf_parser_check_name;
...
*librdf_parser_guess_name = *RDF::Redland::COREc::librdf_parser_guess_name;
*librdf_parser_guess_name2 = *RDF::Redland::COREc::librdf_parser_guess_name2;
*librdf_parser_get_namespaces_seen_prefix = *RDF::Redland::COREc::librdf_parser_get_namespaces_seen_prefix;
*librdf_parser_get_namespaces_seen_uri = *RDF::Redland::COREc::librdf_parser_get_namespaces_seen_uri;
*librdf_parser_get_namespaces_seen_count = *RDF::Redland::COREc::librdf_parser_get_namespaces_seen_count;
...
*librdf_query_results_to_file2 = *RDF::Redland::COREc::librdf_query_results_to_file2;
*librdf_query_results_to_string = *RDF::Redland::COREc::librdf_query_results_to_string;
*librdf_query_results_to_string2 = *RDF::Redland::COREc::librdf_query_results_to_string2;
...
*librdf_query_results_is_syntax = *RDF::Redland::COREc::librdf_query_results_is_syntax;
*librdf_query_results_get_boolean = *RDF::Redland::COREc::librdf_query_results_get_boolean;
*librdf_serializer_check_name = *RDF::Redland::COREc::librdf_serializer_check_name;
...
*librdf_serializer_serialize_stream_to_file = *RDF::Redland::COREc::librdf_serializer_serialize_stream_to_file;
*librdf_serializer_serialize_model_to_file = *RDF::Redland::COREc::librdf_serializer_serialize_model_to_file;
*librdf_serializer_serialize_stream_to_string = *RDF::Redland::COREc::librdf_serializer_serialize_stream_to_string;
